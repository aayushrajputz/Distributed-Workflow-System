...
// Apply fixed rate limit 1000/hr to all webhooks
...
// Generic webhook handler for custom integrations (requires API key)
router.post('/custom/:integrationId', authenticateApiKey, async (req, res) => {
  try {
